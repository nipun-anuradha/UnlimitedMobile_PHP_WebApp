                            ...
                            <div class="card-style mb-30">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2 col-lg-2">
                                        <button class="btn btn-dark" onclick="orderSearch('o');"><i class="lni lni-search"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="table-wrapper table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody id="tbody">
                                            <?php
                                            $order_rs = Database::search("SELECT `date`, `invoice`.id AS oid, `product`.id AS pid, `product`.title, `brand`.name AS bname, `model`.name AS mname, `invoice_item`.qty, fname, lname,
                                            ...
                                            INNER JOIN `province` ON `province`.id=`distric`.province_id WHERE `invoice`.status = 'pendding' ");
